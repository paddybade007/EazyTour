...
//   // ✅ खाली लाइनों को हटाकर शुद्ध गिनती (Fix for "3 instead of 2")
//   const realToursCount = tours.filter(t => t.id && String(t.id).trim() !== "").length;
//   const realFavsCount = favorites.filter(id => id && tours.some(t => t.id === id)).length;
